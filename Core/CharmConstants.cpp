...
const QString MetaKey_LastEventEditorStartDateTime= "LastEventEditorStartDateTime";
const QString MetaKey_LastEventEditorEndDateTime= "LastEventEditorEndDateTime";
