...
void Controller::provideMetaData( Configuration& configuration)
{
    ...
    updateConfigValue<Configuration::TimeTrackerFontSize>(configuration.timeTrackerFontSize, MetaKey_Key_TimeTrackerFontSize);
    updateConfigValue<Configuration::DurationFormat>(configuration.durationFormat, MetaKey_Key_DurationFormat);
    updateConfigValue<Configuration::TaskPrefilteringMode>(configuration.taskPrefilteringMode, MetaKey_Key_SubscribedTasksOnly);
    updateConfigValue<bool>(configuration.detectIdling, MetaKey_Key_IdleDetection);
    updateConfigValue<bool>(configuration.warnUnuploadedTimesheets, MetaKey_Key_WarnUnuploadedTimesheets);
    updateConfigValue<Qt::ToolButtonStyle>(configuration.toolButtonStyle, MetaKey_Key_ToolButtonStyle);
    updateConfigValue<bool>(configuration.showStatusBar, MetaKey_Key_ShowStatusBar);
