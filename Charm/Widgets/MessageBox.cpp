...
static int messageBox(QWidget *parent, const QString &title, const QString &text,
                      QMessageBox::StandardButton yesButton, const QString &yesLabel,
                      QMessageBox::StandardButton noButton, const QString &noLabel,
...
{
    return messageBox(parent, title, text, QMessageBox::Yes, yesLabel, QMessageBox::No, noLabel,
                      defaultButton, QMessageBox::Question);
}
...
{
    return messageBox(parent, title, text, QMessageBox::Yes, yesLabel, QMessageBox::No, noLabel,
                      defaultButton, QMessageBox::Warning);
}
